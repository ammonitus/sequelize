...
var HasOne = function(srcModel, targetModel, options) {
  ...
  this.sourceKeyField = this.target.rawAttributes[this.sourceKey] || this.sourceKey;
...
HasOne.prototype.injectAttributes = function() {
  ...
  Helpers.addForeignKeyConstraints(this.target.rawAttributes[this.foreignKey], this.source, this.target, this.options, this.sourceKeyField);
